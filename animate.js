~function (){
    function animate(ele,target,duration,animateEffect,callback){
        ...
        var defaultEffect = effect.Linear; //默认是一个匀速运动的效果
        if(typeof animateEffect == 'number'){
            switch (animateEffect){
                case 1 :
                    defaultEffect = effect.Back.easeInOut;
                    break;
                case 2:
                    defaultEffect = effect.Bounce.easeInOut;
                    break;
                case 3:
                    defaultEffect = effect.Elastic.easeInOut;
                    break;
            }
        }else if(animateEffect instanceof Array){
            defaultEffect = effect[animateEffect[0]][animateEffect[1]];
